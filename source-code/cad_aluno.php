 ...
 ?>
    	    <div class="container">
              ...
              <br />
    				...
    				<form method="post" action="registra_aluno.php" id="formCadastrarse">
              ...
              <div class="form-group">
    						<input type="text" class="form-control" id="nota" name="nota" placeholder="Nota" required="requiored">
    					</div>

							<div class="form-group">
    						<input type="text" class="form-control" id="orientador" name="orientador" placeholder="Orientador" required="requiored">
    					</div>

							<div class="form-group">
    						<input type="text" class="form-control" id="dataEntrada" name="dataEntrada" placeholder="Semestre de Entrada" required="requiored">
    					</div>
